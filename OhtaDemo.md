...
![](OhtaDemo_files/figure-markdown_github/unnamed-chunk-4-1.png)
...
Of course, dparallel is not meant to be executed in serial. The advantage to using it that multiple instances can be executed at the same time. Consider a simple rscript called examparallel.R.
